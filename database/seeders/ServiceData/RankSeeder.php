    ...
    public function run(): void
    {
        $ranks = [
            ...
            [
                ...
                'air_guard' => json_encode(['Non-Technical' => 'Junior Aircraftman', 'Technical' => 'Junior Technician']),
                'air_guard_abbreviation' => json_encode(['Non-Technical' => 'JAC', 'Technical' => 'JT']),
            ],
            [
                'name' => 'E3',
                ...
                'air_guard' => json_encode(['Non-Technical' => 'Senior Aircraftman', 'Technical' => 'Senior Technician']),
                'air_guard_abbreviation' => json_encode(['Non-Technical' => 'SAC', 'Technical' => 'ST']),
            ],
            [
                'name' => 'E4',
                'regiment' => 'Corporal',
